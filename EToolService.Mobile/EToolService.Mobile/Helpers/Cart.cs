...
namespace EToolService.Mobile.Helpers
{
    /// <summary>
    ...
    /// </summary>
    public class Cart<T> : ICollection<T>, IEnumerable
    {
        ...
        public Pair<T> GetElement(int index)
        {
        ...
        /// implement your own Equals() method.
        /// </summary>
        public static Cart<T> FromCollection(IEnumerable<T> collection)
        {
            if (collection == null)
                throw new ArgumentNullException();

            Cart <T> rep = new Cart<T>();
